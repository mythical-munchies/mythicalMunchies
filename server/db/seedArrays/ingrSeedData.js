const ingredients = [
  ...
  { name: "Onion", description: "Sliced" },
  { name: "Corn on the cob", description: "Cut into halves or thirds" },
  { name: "Butter", description: "Melted" },
  ...
  { name: "Tomatoes", description: "Diced" },
  ...
  { name: "Onion", description: "Chopped" },
  { name: "Garlic", description: "Minced" },
  { name: "Ginger", description: "Minced" },
  ...
  { name: "Cayenne pepper", description: "" },
  { name: "Salt", description: "To taste" },
  { name: "Black pepper", description: "To taste" },
  { name: "Tomatoes", description: "Diced" },
