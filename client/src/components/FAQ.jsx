    ...
    <div className="background">
      ...
      <div className="accordion-container">
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="h7">
              ...
              immortal taste testers to ensure that they're not only delicious
              but also safe for consumption. However, we cannot be held
              responsible for any unexpected side effects, such as temporary
              invisibility or spontaneous levitation.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="h7">
              ...
              unfortunately cannot offer discounts based on magical status
              alone. However, keep an eye out for special promotions and sales
              that may sprinkle a little extra enchantment into your shopping
              experience.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="h7">
              ...
              Olympus. We use the latest magical encryption spells to protect
              your information and ensure that your shopping experience is as
              safe as it is enjoyable. Plus, every purchase comes with a free
              charm to ward off pesky internet trolls.
            </Typography>
          </AccordionDetails>
        </Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography variant="h7">
              Absolutely! We love getting creative with our culinary
              concoctions. Whether you're craving a dish fit for a siren's song
              or a potion to rival Merlin's magic, just let us know your
              desires, and we'll work our culinary wizardry to make it happen.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <div>
